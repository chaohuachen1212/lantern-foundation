...
<?php wp_head(); ?>
  ...
  <body class="<?php echo get_option('body_class'); ?>">
    ...
    <?php if( get_field('turn_on_dev', 'options') ) { ?>
      <div id="dev-config--width">
        <span class="bp"></span>
        <span class="currentWidth"></span>
      </div>
      <script>
        const width = document.querySelector('#dev-config--width span.currentWidth');
