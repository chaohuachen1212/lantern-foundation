<?php
  ...
  update_option('body_class', 'our-project theme-magenta new-nav');
  get_header();
?>
...
Learn more about our ongoing campaigns and/or upcoming events below!</h3>
    ...
    <div class="campaign1">
      ...
      <div class="content1">
        <img class="img1" src="http://lantern-foundation.local/wp-content/themes/lantern-foundation/img/our-project/image1.jpg">
        ...
        <img class="img2" src="http://lantern-foundation.local/wp-content/themes/lantern-foundation/img/our-project/image2.jpg">
        ...
        <img class="img3" src="http://lantern-foundation.local/wp-content/themes/lantern-foundation/img/our-project/image3.jpg">
        ...
        <img class="img4" src="http://lantern-foundation.local/wp-content/themes/lantern-foundation/img/our-project/image4.jpg">
      </div>
    </div>
    ...
    <div class="campaign2">
      ...
      <div class="content2">
        <img class="img1" src="http://lantern-foundation.local/wp-content/themes/lantern-foundation/img/our-project/image5.jpg">
        ...
        <img class="img2" src="http://lantern-foundation.local/wp-content/themes/lantern-foundation/img/our-project/image6.jpg">
        ...
        <img class="img3" src="http://lantern-foundation.local/wp-content/themes/lantern-foundation/img/our-project/image7.jpg">
    ...
    <div class="campaign3">
      ...
      <div class="content3">
        <img class="img1" src="http://lantern-foundation.local/wp-content/themes/lantern-foundation/img/our-project/image8.jpg">
        ...
        <img class="img2" src="http://lantern-foundation.local/wp-content/themes/lantern-foundation/img/our-project/image9.jpg">
        ...
        <img class="img3" src="http://lantern-foundation.local/wp-content/themes/lantern-foundation/img/our-project/image10.jpg">
        <p>As Rodney Naidoo, a teacher in South Africa, said, “We can only break the poverty cycle through education.” Although those that live in rural communities might not understand the value of education, we must work to ensure that kids in rural China have an equal opportunity to learn and grow.</p>
      </div>
    </div>
